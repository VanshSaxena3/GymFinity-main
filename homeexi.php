...
<section id="team" class="pb-5">
    <div class="container">
        ...
        <div class="row">
                        ...
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="./Images/push-ups.jpg" alt="card image"></p>
                ...
                <div class="image-flip" >
                    <div class="mainflip flip-0">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="./Images/deadlift.jpg" alt="card image"></p>
            ...
            <a href="home.php" style="display: block; text-align: center; text-decoration: none; color: #007bff; font-weight: bold;" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'">Explore more</a>
